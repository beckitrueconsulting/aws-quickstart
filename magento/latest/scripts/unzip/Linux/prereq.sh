...
download_magento() {
    cd /home/ec2-user/misc
    wget https://s3.amazonaws.com/${BUILDBUCKET}/magento/latest/media/${MAGENTO_TAR} --output-document=/home/ec2-user/misc/${MAGENTO_TAR}
    wget https://s3.amazonaws.com/${BUILDBUCKET}/magento/latest/media/${MAGENTO_SAMPLE} --output-document=/home/ec2-user/misc/${MAGENTO_SAMPLE}    
...
install_magento_sample() {
    ...
    cp -r /home/ec2-user/misc/magento-sample-data-1.9.0.0/media/* /var/www/html/magento/media/
    cp -r /home/ec2-user/misc/magento-sample-data-1.9.0.0/skin/* /var/www/html/magento/skin/
    cp /home/ec2-user/misc/magento-sample-data-1.9.0.0/magento_sample_data_for_1.9.0.0.sql /home/ec2-user/misc/scripts
    mysql -u RDSUSER-REPLACE-ME --password=PASSWORD-REPLACE-ME -h RDS-HOST-REPLACEME -P RDS-PORT-REPLACEME magento < /home/ec2-user/misc/magento-sample-data-1.9.0.0/magento_sample_data_for_1.9.0.0.sql
...
#   php memory
    ...
    if (( ${INSTALLMAGENTOSAMPLE} == 1 )); then
        if (( $(ifmediaempty) == 1  && $(ifFirstnode) == 1 )); then
            ...
            /bin/sh /home/ec2-user/misc/scripts/cmdInstall.sh 
            setpermissions
            apachectl -k restart
        else
